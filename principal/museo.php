        ...
        <article class="museo">
            ...
            <div class="bottom">
                <div class="address">
                    ...
                    <?php if ($museo["detalles"] != "") {echo "<p><b>Detalles de la dirección: </b>" . $museo["detalles"];}?>
                    <?php if ($museo["map_url"] != "") {echo "<p><a href='" . $museo["map_url"] . "' target='_blanck'><img src='../media/img/link.png'> Ver en el mapa</a></p>";}?>
                    <?php if ($museo["address_url"] != "") {echo "<p><a href='" . $museo["address_url"] . "' target='_blanck'><img src='../media/img/link.png'> Página oficial de '" . $museo["nombre"] . "'</a></p>";}?>
                </div>
                <div class="data">
